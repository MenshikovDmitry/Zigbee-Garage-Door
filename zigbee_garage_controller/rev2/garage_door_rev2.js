...
const device = {
    zigbeeModel: ['garage_door_rev2'],
    model: 'garage_door_rev2',
    vendor: 'KOTAH',
    ...
    exposes: [e.switch().withEndpoint('l1'),
      ...
      e.contact().withEndpoint('l3'),
      e.contact().withEndpoint('l4'),
      e.action(['single', 'double', 'triple', 'hold', 'release']),
      ...ptvo_on_off_config_exposes('l1'),
      ...ptvo_on_off_config_exposes('l3'),
      ...ptvo_on_off_config_exposes('l4'),
],
    meta: {
        multiEndpoint: true,
        binaryEndpoints: {'l3': 'contact', 'l4': 'contact', }, 
    },
    endpoint: (device) => {
        return {
            l1: 1, l2: 2, l3: 3, l4: 4,
